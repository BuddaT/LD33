...
public class BodyPart extends Part {
	...
	private static final int ROTATE_SPEED = 250, ROTATE_AMNT = -8;
	...
	public void render(GameContainer gc, Graphics g, boolean highlight) {
		...
		if (!isDead())
			g.rotate(200, 214 + getHeight(), rotation);
		g.drawImage(getImage(), 72, 214, c);
		if (!isDead())
			g.rotate(200, 214 + getHeight(), -rotation);
	}
	...
	public void init(GameContainer gc) {
		...
		bounds = new Rectangle(72 + 64, 214 + 64, getWidth(), getHeight());
	}
}
